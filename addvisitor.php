...
<div class="maincontent">
    ...
    <div class="modifydiv" style="width:80vw;height:90vh;text-align:center;margin-top:60px">
        <form method="post" action="php/add.php">
            ...
            <input style="font-size: 32px;margin-bottom:15px;border-radius:12px;text-align:center" type="text" name="usn" id="usn"><br>
            <label style="font-size: 32px;margin-bottom:15px" class="modifyinput" for="sname">Student Name</label><br>
            <input style="font-size: 32px;margin-bottom:15px;border-radius:12px;text-align:center" type="text" name="sname" id="sname"><br>
            <label style="font-size: 32px;margin-bottom:15px" class="modifyinput" for="vname">Visitor Name</label><br>
            <input style="font-size: 32px;margin-bottom:15px;border-radius:12px;text-align:center" type="text" name="vname" id="vname"><br>
            <label style="font-size: 32px;margin-bottom:15px;border-radius:12px" for="relation">Relation</label><br>
            <input style="font-size: 32px;margin-bottom:15px;border-radius:12px;text-align:center" type="text" name="relation" id="relation"><br>
            <label style="font-size: 32px;margin-bottom:15px;border-radius:12px" for="vphoneno">visitor phone :</label><br>
            <input style="font-size: 32px;margin-bottom:15px;border-radius:12px;text-align:center" type="number" name="vphoneno" id="vphoneno"><br>
