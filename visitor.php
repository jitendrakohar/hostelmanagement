    ...
    <body>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="visitordelete.php?id=<?php echo $row['usn']; ?>"><img src="icons/trash-alt-solid.svg"></a></td>
        ...
        <div class="wrapperbutton">
            <div class="button divAdd">
                ...
                <a style="text-decoration:none" href="addvisitor.php"><button class="Add"> ADD VISITOR</button></a>
            </div>
